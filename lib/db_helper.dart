...
class DBHelper {
  ...
  /// Adds a single student locally (e.g. from a manual entry) and
  /// marks it unsynced so the sync service pushes it to Supabase.
  ...
  Future<int> addAttendance(String sessionName, String date, String studentId,
    ...
    return db.insert(
      ...
      conflictAlgorithm: ConflictAlgorithm.ignore, // silently no-ops on duplicate scan
    );
  }
